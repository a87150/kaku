# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-18 10:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(verbose_name='content')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='created time')),
                ('article', models.ForeignKey(blank=False, null=False, on_delete=django.db.models.deletion.CASCADE, to='written.Article', verbose_name='article')),
            ],
        ),
    ]
